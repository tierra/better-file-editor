...
var better_file_editor = (function() {
	...
	module.initialize = function() {
		...
		<div id="wp-ace-editor-controls"><table><tr>\
			<td>\
				<label for="editor_theme">' + bfe_l10n.editor_theme_label + '</label>\
				<select id="editor_theme" size="1">\
					<optgroup label="' + bfe_l10n.editor_theme_bright_label + '">\
					...
					<optgroup label="' + bfe_l10n.editor_theme_dark_label + '">\
			...
			<td>\
				<label for="fontsize">' + bfe_l10n.fontsize_label + '</label>\
			...
			<td>\
				<input type="checkbox" id="show_ruler" checked />\
				<label for="show_ruler">' + bfe_l10n.show_ruler_label + '</label>\
			</td>\
			<td>\
				<input type="checkbox" id="show_gutter" checked />\
				<label for="show_gutter">' + bfe_l10n.show_gutter_label + '</label>\
			</td>\
			<td>\
				<input type="checkbox" name="show_whitespace" id="show_whitespace" />\
				<label for="show_whitespace">' + bfe_l10n.show_whitespace_label + '</label>\
			</td>\
		</tr></table></div>\
		...
		bindCheckbox('show_whitespace', function(checked) {
		...
		bindCheckbox('show_ruler', function(checked) {
			editor.renderer.setShowPrintMargin(checked);
		});
	}

	module.save_setting = function(el, val) {
	...
	module.bindCheckbox = function(id, callback) {
	...
	module.bindDropdown = function(id, callback) {
		var el = document.getElementById(id);
		if (localStorage && localStorage.getItem(id))
